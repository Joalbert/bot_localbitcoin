...
from examples.script_update_price import (Main, 
        get_ads_from_file, script_main, get_banks_from_file,
        filter_banks)
from models import Ad, ChatMessage, Feedback, UserData
...
ADS = [Ad(int("1442920"), Decimal("142613.52"), Decimal("14.27"), 
        ...
        "thd68"),
        Ad(int("1410674"),Decimal("155043.14"), Decimal("150.00"), Decimal("1814.56"),
...
DUMMY_ADS = [Ad(int("1442920"), Decimal("142613.52"), Decimal("14.27"), 
        ...
        "SANTANDER",
        "rivaliño"),
        Ad(int("1410672"),Decimal("155043.14"), Decimal("150.00"), Decimal("1814.56"),
        "S A N T A N D E R",
        "rivaliño"),
        ...
        "CARIBE",
        "rivaliño"),
        Ad(int("1410676"),Decimal("155043.14"), Decimal("150.00"), Decimal("1814.56"),
        "CARIBE",
        "rivaliño")]
...
class TestUpdatePrice(TestCase):
    ...
    def test_cli_update(self):
        ...
        with patch("examples.script_update_price.ConnectionLocalBitcoin") as connection:
            connection.return_value = MockConnection(CREDENTIALS)
