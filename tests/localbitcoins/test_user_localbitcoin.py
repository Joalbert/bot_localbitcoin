...
from tests.mocks import (MockConnection, mock_list_ad, 
            ...
            mock_list_chat_messages, mock_list_order, mock_list_all_chat_messages)
from tests import SELL_JSON_LOC, BUY_JSON_LOC, CLOSED_ORDER_LOC, OPENED_ORDER_LOC
...
class TestUser(TestCase):
    ...
    def test_write_message_chat(self):
        self.assertTrue(self.user.write_message_chat(Chat(1), 
                ChatMessage(1,self.username,"Hello World!")
                )
            )
